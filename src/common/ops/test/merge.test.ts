...
describe('merge', () => {
  ...
  test('addLeafToEmpty', () => {
    ...
    assert.deepStrictEqual(original, [{ key: e.foo, value: 42, version: 3 }]);
  });
  ...
  test('updateLeafOlder', () => {
    ...
    assert.deepStrictEqual(original, [{ key: e.foo, value: 41, version: 3 }]);
  });
});
...
describe('branches', () => {
  ...
  test('updateLeafWithOlderBranch', () => {
    ...
    assert.deepStrictEqual(original, [{ key: e.foo, value: 10, version: 2 }]);
  });
  ...
  test('updateBranchWithNewerLeaf', () => {
    ...
    assert.deepStrictEqual(original, [{ key: e.foo, value: 10, version: 3 }]);
  });
});
...
describe('addToRange', () => {
  ...
  test('addOldLeafToRangeStart', () => {
    ...
    merge(original, [{ key: e.foo, value: 42, version: 2 }]);
    assert.deepStrictEqual(original, [{ key: e.foo, end: e.gah, version: 3 }]);
  });
