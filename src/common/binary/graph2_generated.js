 ...
 */
graph.GraphNode.prototype.__init = function(i, bb) {
  this.bb_pos = i;
  this.bb = bb;
  return this;
};
...
/**
 * @param {flatbuffers.ByteBuffer} bb
 * @param {graph.GraphNode=} obj
 * @returns {graph.GraphNode}
 */
graph.GraphNode.getRootAsGraphNode = function(bb, obj) {
  return (obj || new graph.GraphNode).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};
 ...
 * @returns {graph.GraphNode}
 */
graph.GraphNode.getSizePrefixedRootAsGraphNode = function(bb, obj) {
  bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
  return (obj || new graph.GraphNode).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};

/**
 * @returns {graph.GraphNodeUnion}
 */
graph.GraphNode.prototype.nodeType = function() {
  var offset = this.bb.__offset(this.bb_pos, 4);
  return offset ? /** @type {graph.GraphNodeUnion} */ (this.bb.readUint8(this.bb_pos + offset)) : graph.GraphNodeUnion.NONE;
};
 ...
 */
graph.GraphNode.prototype.node = function(obj) {
 ...
 */
graph.GraphNode.startGraphNode = function(builder) {
  builder.startObject(2);
};

/**
 * @param {flatbuffers.Builder} builder
 * @param {graph.GraphNodeUnion} nodeType
 */
graph.GraphNode.addNodeType = function(builder, nodeType) {
  builder.addFieldInt8(0, nodeType, graph.GraphNodeUnion.NONE);
};
 ...
 */
graph.GraphNode.addNode = function(builder, nodeOffset) {
 ...
 */
graph.GraphNode.endGraphNode = function(builder) {
 ...
 * @returns {flatbuffers.Offset}
 */
graph.GraphNode.createGraphNode = function(builder, nodeType, nodeOffset) {
  graph.GraphNode.startGraphNode(builder);
  graph.GraphNode.addNodeType(builder, nodeType);
  graph.GraphNode.addNode(builder, nodeOffset);
  return graph.GraphNode.endGraphNode(builder);
}
 ...
 * @returns {number}
 */
graph.GraphItem.prototype.child = function(index) {
 ...
 * @returns {number}
 */
graph.GraphItem.prototype.childLength = function() {
  var offset = this.bb.__offset(this.bb_pos, 8);
  return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
};
 ...
 * @returns {Uint8Array}
 */
graph.GraphItem.prototype.childArray = function() {
  var offset = this.bb.__offset(this.bb_pos, 8);
  return offset ? new Uint8Array(this.bb.bytes().buffer, this.bb.bytes().byteOffset + this.bb.__vector(this.bb_pos + offset), this.bb.__vector_len(this.bb_pos + offset)) : null;
};
...
/**
 * @param {flatbuffers.Builder} builder
 * @param {flatbuffers.Offset} childOffset
 */
graph.GraphItem.addChild = function(builder, childOffset) {
  builder.addFieldOffset(2, childOffset, 0);
};
 ...
 * @returns {flatbuffers.Offset}
 */
graph.GraphItem.createChildVector = function(builder, data) {
  builder.startVector(1, data.length, 1);
  for (var i = data.length - 1; i >= 0; i--) {
    builder.addInt8(data[i]);
  }
 ...
 * @param {number} numElems
 */
graph.GraphItem.startChildVector = function(builder, numElems) {
  builder.startVector(1, numElems, 1);
};
 ...
 * @returns {flatbuffers.Offset}
 */
graph.GraphItem.createGraphItem = function(builder, keyOffset, versionOffset, childOffset) {
  ...
  graph.GraphItem.addChild(builder, childOffset);
...
graph.PathSeg.addIsprefix = function(builder, isprefix) {
  builder.addFieldInt8(0, +isprefix, +false);
};
 ...
 * @returns {flatbuffers.Offset}
 */
graph.PathSeg.createPathSeg = function(builder, isprefix) {
