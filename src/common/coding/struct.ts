import { addStringify } from '../util.ts';
import { decode as decodeNumber, encode as encodeNumber } from './number.ts';
import { decode as decodeString, encode as encodeString } from './string.ts';
