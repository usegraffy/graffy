...
describe('references', () => {
  test('point', () => {
    ...
    assert.deepStrictEqual(result.foo.$ref, ['bar']);
  });
});
...
describe('pagination', () => {
  ...
  test('simpleArray', () => {
    ...
    assert.deepStrictEqual(result, { baz: expected });
  });
});
...
test('arrayCursor.decode', () => {
  ...
  assert.deepStrictEqual(decorated, expected);
});
...
test('alias', () => {
  ...
  assert.deepStrictEqual(result, { bar: expectedArray });
  assert.deepStrictEqual(result.bar.$ref, expectedArray.$ref);
});
...
describe('val_null', () => {
  test('implicit', () => {
    ...
    assert.deepStrictEqual(result, { foo: { bar: null } });
  });
