...
test('inter', () => {
  ...
  expect(inter([1, 4, 7, 8], [3, 7])).toEqual([3, 4]);
...
test('diff', () => {
  ...
  // This operation is not correctly representable as we lack an
  // open/closed interval distinction.
  expect(diff([1, 4, 7, 9], [3, 3, 5, 5])).toEqual([1, 3, 3, 4, 7, 9]);
});
